    ...
    <section id="hero" className="bg-black py-20 lg:py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <div className="relative flex justify-center items-center mb-12 w-full h-64">
            
            {/* ✨ MODIFIED: Left Video with larger size and inner shadow */}
            <div className="absolute left-0 top-1/2 -translate-y-1/2 md:left-auto md:-translate-x-64 group">
              <video 
                ref={leftVideoRef}
                src={`${process.env.PUBLIC_URL}/videos/intro_left.mp4`} 
                autoPlay loop muted playsInline
                className="w-64 h-64 rounded-xl object-cover border-2 border-pink-500/30 shadow-lg shadow-pink-500/20 shadow-inner shadow-white/10"
              ></video>
              <button 
            ...
            {/* ✨ MODIFIED: Right Video with larger size and inner shadow */}
            <div className="absolute right-0 top-1/2 -translate-y-1/2 md:right-auto md:translate-x-64 group">
              <video 
                ref={rightVideoRef}
                src={`${process.env.PUBLIC_URL}/videos/intro_right.mp4`} 
                autoPlay loop muted playsInline
                className="w-64 h-64 rounded-xl object-cover border-2 border-green-500/30 shadow-lg shadow-green-500/20 shadow-inner shadow-white/10"
              ></video>
              <button 
