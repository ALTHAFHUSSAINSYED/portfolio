    ...
    <section id="about" className="pt-8 pb-20 bg-gradient-to-b from-background to-secondary relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {selectedAward && selectedAward.awardUrl && (
          ...
          >
            <div
              className={`relative ${selectedAward.title.includes('FY26 H1') ? 'max-w-xl' : 'max-w-4xl'} w-full bg-background rounded-xl shadow-2xl overflow-hidden border border-cyan-400/30`}
