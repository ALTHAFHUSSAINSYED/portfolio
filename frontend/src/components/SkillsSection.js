...
const SkillsSection = ({ skills }) => {
  ...
  const mapToSkills = (items, defaultLevel = 'Advanced') =>
    (items || []).map(item => (typeof item === 'string' ? { name: item, level: defaultLevel } : item));

  const skillCategories = [
    {
      title: 'Cloud Platforms',
      icon: Cloud,
      items: mapToSkills(skills['Cloud Platforms'], 'Expert'),
    ...
    },
    {
      ...
      icon: Settings,
      items: mapToSkills(skills['CI/CD'], 'Expert'),
    ...
    },
    {
      ...
      icon: Database,
      items: mapToSkills(skills['Containerisation & Orchestration'], 'Expert'),
    ...
    },
    {
      ...
      icon: Code,
      items: mapToSkills(skills['Infrastructure as Code & Automation'], 'Expert'),
    ...
    },
    {
      ...
      icon: Award,
      items: mapToSkills(skills['Monitoring & Logging'], 'Advanced'),
    ...
    },
    {
      ...
      icon: Settings,
      items: mapToSkills(skills['Build & Quality Management'], 'Advanced'),
    ...
    },
    {
      ...
      icon: Code,
      items: [...mapToSkills(skills['Linux Administration']), ...mapToSkills(skills['Networking & Security'])],
    ...
    },
    {
      ...
      icon: Settings,
      items: [...mapToSkills(skills['Collaboration & Processes']), ...mapToSkills(skills['Soft Skills'])],
    ...
    <section id="skills" className="py-20 bg-gradient-to-b from-secondary to-background relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white shine-text">
            Technical Skills - DevOps & Cloud Expertise
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {skillCategories.map((category, categoryIndex) => {
            ...
            return (
              ...
              <Card
                key={categoryIndex}
                className={`p-6 transition-all duration-500 backdrop-blur-sm neon-card hover-lift ${isVisible ? `fade-in-up stagger-${categoryIndex + 2}` : ''
                  }`}
              >
