...
export const portfolioData = {
  personalInfo: {
    ...
    summary: "DevOps Engineer with 3.10 years of experience in AWS cloud infrastructure, CI/CD automation, Infrastructure as Code (IaC), application deployment, monitoring, and production support. Hands-on experience with AWS services including EC2, VPC, IAM, Route53, Auto Scaling, Lambda, CloudWatch, ECS, and EKS. Skilled in Terraform, Jenkins, GitHub Actions, AWS CodePipeline, Docker, Kubernetes, Linux, Bash, and Python scripting. Experienced in application onboarding, DevOps toolchain support, incident resolution, root cause analysis, and implementing automation solutions within Agile, SDLC, and ITIL-driven environments.",
